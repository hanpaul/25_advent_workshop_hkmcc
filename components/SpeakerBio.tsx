    ...
    <section className="py-16 sm:py-24 bg-white/5">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-serif font-bold text-amber-100">Guest Speaker</h2>
        </div>
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          <div className="flex-shrink-0">
            <img 
              ...
              className="w-48 h-48 md:w-64 md:h-64 rounded-full object-cover shadow-2xl shadow-purple-900/50"
            />
          </div>
          <div className="text-center lg:text-left text-gray-300">
            <h3 className="text-2xl sm:text-3xl font-serif font-bold text-amber-200">Dr. Robert Navarra</h3>
            <p className="text-md text-gray-400 mt-1">Licensed Marriage and Family Therapist, Master Addiction Counselor</p>
